...
//KLIK TOMBOL SUBSCRIBE !!!! https://youtube.com/channel/UCvQtanfycsSwLbC0CAwB1rw
//AWAS GA SUBSCRIBE TAR GUE GA UP SC LAGI NI
//MAU GUE ENC?
//KALO MAU YANG NO ENC TERUS KLIK TOMBOL SUBSCRIBE LAH https://youtube.com/channel/UCvQtanfycsSwLbC0CAwB1rw
const {
    WAConnection,
	MessageType,
	Presence,
...
petik = '```'
fake = '©Created By Chann Botz'//GANTI NAMA KAMU BEP
ban =[]
...
module.exports = dha = async (dha, mek) => {
	try {
        ...
        const listmsg = (from, title, desc, list) => { // ngeread nya pake rowsId, jadi command nya ga keliatan
            let po = dha.prepareMessageFromContent(from, {"listMessage": {"title": title,"description": desc,"buttonText": "𝕾𝖎𝖑𝖆𝖍𝖐𝖆𝖓 𝕻𝖎𝖑𝖎𝖍 𝕯𝖎𝖘𝖓𝖎!","footerText": "Chann Botz️","listType": "SINGLE_SELECT","sections": list}}, {})
     ...
     const time2 = moment().tz('Asia/Jakarta').format('HH:mm:ss')
       ...
       console.error(err)
        ...
        const ftoko = {key: {fromMe: false,participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "16505434800@s.whatsapp.net" } : {})},message: {"productMessage": {"product": {"productImage":{"mimetype": "image/jpeg","jpegThumbnail": fs.readFileSync(`./media/sherlynn.jpg`)},"title": `©Chann Botz`,"description": "ItsMeBotz", "currencyCode": "IDR","priceAmount1000": "99999999","retailerId": "Chann Botz","productImageCount": 1},"businessOwnerJid": `0@s.whatsapp.net`}}}
...
*Sewa bot?* Chat wa.me/6281337963107`
               ...
               buttonsMessage = {
               contentText: `${menu}`,
               footerText: 'Chann Botz', imageMessage: imageMsg,
               buttons: buttons,
               headerType: 4
}
...
*Cek list Server GTIVD dibawah!*`
       ...
       case 'othercmd':
               ...
               startnum = 0
               for (let x of listmenu) {
               const yy = {title: 'Chann Botz' + nombor++,
                    rows: [
                       {
                        title: `${listmenuu[startnum++]}`,
                        description: ``,
               ...
               const yy = {title: 'Silahkan di pilih' + nombor++,
                    rows: [
                       {
                        title: `${listmenuu[startnum++]}`,
                        footerText: 'case by Chann Botz', imageMessage: imageMsg,
                        rowId: `${prefix}${x}`
                      }
                    ]
                   }
...
//------------------< Game >------------------- 
        case 'limitgame': 
        case 'bChannce': 
               const bChannce = atm.checkATMuser(sender, _uang)
               if (isPremium) return reply(`Limit Game : Unlimited\nBChannce : Rp.${bChannce}`)
         ...
         case 'gelud':
               ...
               if (fs.existsSync(`./media/${from}.json`)) return reply(`Sedang Ada Sesi, tidak dapat dijChannkan secara bersamaan\nKetik *${prefix}delsesigelud*, untuk menghapus sesi`)
...
//------------------< by Chann Botz >-------------------  
case 'audio1':
man = fs.readFileSync('./ChannBotz/audio1.mp3');
dha.sendMessage(from, man, MessageType.audio, {quoted: ftoko, mimetype: 'audio/mp4', ptt:true})
break
case 'audio2':
man = fs.readFileSync('./ChannBotz/audio2.mp3');
dha.sendMessage(from, man, MessageType.audio, {quoted: ftoko, mimetype: 'audio/mp4', ptt:true})
break
case 'audio3':
man = fs.readFileSync('./ChannBotz/audio3.mp3');
dha.sendMessage(from, man, MessageType.audio, {quoted: ftoko, mimetype: 'audio/mp4', ptt:true})
break
case 'audio4':
man = fs.readFileSync('./ChannBotz/audio4.mp3');
dha.sendMessage(from, man, MessageType.audio, {quoted: ftoko, mimetype: 'audio/mp4', ptt:true})
break
case 'audio5':
man = fs.readFileSync('./ChannBotz/audio5.mp3');
dha.sendMessage(from, man, MessageType.audio, {quoted: ftoko, mimetype: 'audio/mp4', ptt:true})
break
case 'audio6':
man = fs.readFileSync('./ChannBotz/audio6.mp3');
dha.sendMessage(from, man, MessageType.audio, {quoted: ftoko, mimetype: 'audio/mp4', ptt:true})
break
case 'audio7':
man = fs.readFileSync('./ChannBotz/audio7.mp3');
dha.sendMessage(from, man, MessageType.audio, {quoted: ftoko, mimetype: 'audio/mp4', ptt:true})
break
//------------------< bayar menu >-------------------  
case 'bayar':
...
*Chat Owner :* wa.me/6281337963107`
              dha.sendMessage(from, await getBuffer(gopeynya), image, {quoted: ftoko, caption: teksnya })
              break
case 'pricegtfo':
              gopeynya = 'https://i.ibb.co/kynNYTh/ganteng.jpg'
...
*ID Guild :* -
*Minat Join? Chat* wa.me/6281337963107
#WAVEFOREVER!`
              dha.sendMessage(from, await getBuffer(gopeynya), image, {quoted: ftoko, caption: teksnya })
              break
...
//------------------<18+ Menu>-----------------------   
       case 'randombokep':
              ...
              dha.sendMessage(from, '*PERMINTAAN:* '+bokep+'\n*DOSA TANGGUNG PRIBADI*\n*NI BRO FREE BUAT KAMU DOWNLOAD SENDIRI:* '+ kep, text, { quoted: ftoko, caption: `NI BOKEP SAYA DAPAT DARI *©Chann Botz* DOSA TANGGUNG SENDIRI🗿`})
              break
                case 'xnxx':
...
//------------------< Menunya Bang:v >-------------------
      case 'dana':
         ...
         case 'pulsa':
             ...
             break              
      case 'infoig':
             reply(`Follow Instagram Owner Ya : https://instagram.com/cal_me_jb_Channganz?utm_medium=copy_link`)
             break
      case 'grupbot':
...
reply('_' + err + '_\n\n' + js)
       ...
       if (budy.includes(`@6281337963107`)) {
